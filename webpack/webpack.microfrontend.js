  ...
  return {
    plugins: [
      new ModuleFederationPlugin({
        remotes: {
          metaenix: 'metaenix@/services/metaenix/remoteEntry.js',
          metastore: 'metastore@/services/metastore/remoteEntry.js',
          metalive: 'metalive@/services/metalive/remoteEntry.js',
        },
        shared: {
